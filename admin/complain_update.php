    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-uppercase">
                ...
                <li class="breadcrumb-item"><a href="admin_list.php" class="text-decoration-none ">Complains Lists</a>
                </li>
                <li class="breadcrumb-item active fw-bold user-select-none" aria-current="page">Update Complain Status
                </li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card-body">
                ...
                <form method="post" class="row mt-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="status" id="category_id" aria-label="Default select example"
                            required>
                            <?php foreach ($complainStatus as $key=>$value){ ?>
                            <option value="<?php echo $key; ?>" <?php echo $key== $current['status']?"selected":""?>>
