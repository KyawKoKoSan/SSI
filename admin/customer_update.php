    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-uppercase">
                ...
                <li class="breadcrumb-item"><a href="customer_list.php" class="text-decoration-none ">Customers
                        Lists</a></li>
                <li class="breadcrumb-item active fw-bold user-select-none" aria-current="page">Update Customer Account
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="">
                        <a href="customer_list.php" class="btn btn-outline-secondary me-2"><i
                ...
                <form method="post" class="row mt-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <input type="text" value="<?php echo $current['address']; ?>" name="address"
                            class="form-control" id="inputAddress" placeholder="1234 Main St" required>
                    </div>
                    <div class="col-md-6 mt-2">
                        <label for="inputPhone" class="form-label">Phone Number</label>
                        <input type="number" value="<?php echo $current['phone']; ?>" name="phone" class="form-control"
                            id="inputPhone" placeholder="+95989072612" required>
                    </div>
                    <div class="col-md-6 mt-2">
                        <label for="inputCity" class="form-label">City</label>
                        <input type="text" value="<?php echo $current['city']; ?>" name="city" class="form-control"
                            id="inputCity" placeholder="Yangon" required>
                    </div>
                    <div class="col-md-6 mt-2">
