    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-uppercase">
                ...
                <li class="breadcrumb-item active fw-bold user-select-none" aria-current="page">Promotions Lists</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 text-uppercase"><i class="feather-list text-primary me-2"></i>Promotions List</h4>
                    <div class="">
                        <a href="promotion_add.php" class="btn btn-outline-secondary me-2"><i class="feather-plus-circle"></i></a>
                            ...
                            <div class="" style="overflow-x: scroll">
                                <table class="table table-hover table-responsive " id="products-list">
                                    <thead class="text-uppercase">
                                        ...
                                        <th class="text-nowrap">Started At</th>
