                                            ...
                                            <form action="" method="post">
                                                <tr>
                                                    <th colspan="8">
                                                        <div class="col-12 col-md-5 col-lg-3">
                                                            <label for="inputCardNum" class="form-label">Card
                                                                Number</label>
                                                            <input type="number" name="card_num" class="form-control"
                                                                id="inputCardNum" placeholder="1234 1234 1234 1234"
                                                                required>
                                                        </div>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="text-dark h3">
                                                        <label for="expMonth" class="form-label">Expiration
                                                            Month</label>
                                                        <input type="number" min="1" max="12" name="expMonth"
                                                            class="form-control" id="expMonth" placeholder="MM"
                                                            required>
                                                    </td>
                                                    <td colspan="3" class="text-dark h3">
                                                        <label for="expYear" class="form-label">Expiration Year</label>
                                                        <input type="number" min="2023" max="2099" name="expYear"
                                                            class="form-control" id="expYear" placeholder="YY" required>
                                                    </td>
                                                    <td colspan="2">
