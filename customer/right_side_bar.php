<div class="col-12 col-lg-3 wow animate__bounceInRight delay-5s">
    <div class="sticky-cards">
        ...
        <div class="list-group col-12 mb-3">
            ...
            <a href="services_by_category.php?category_id=<?php echo $c['id'];?>"
                class="<?php echo isset($_GET['category_id']) ?$_GET['category_id']==$c['id']?'active':'' :'' ?> list-group-item list-group-item-action"><?php echo $c['title']?></a>
            <?php } ?>
        </div>
                ...
                <div class="card slick-card">
                    ...
                    <div class="card-body">
                        ...
                        <h6><span
                                ...
                                class="final-price-text"><?php echo $i['sale_price'] ;?>$</span></h6>
                        <div class="row">
